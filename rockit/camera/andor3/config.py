...
CONFIG_SCHEMA = {
    ...
    'required': [
        ...
        'worker_processes', 'framebuffer_bytes', 'header_card_capacity', 'binning',
...
class Config:
    ...
    def __init__(self, config_filename):
        ...
        self.pipeline_daemon_name = config_json.get('pipeline_daemon', None)
        ...
        self.filter = config_json.get('filter', None)
